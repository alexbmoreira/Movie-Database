...
public class MovieTableController
{
	...
	@FXML CheckBox actionBox;
	@FXML CheckBox adventureBox;
	@FXML CheckBox animationBox;
	@FXML CheckBox biographyBox;
	@FXML CheckBox comedyBox;
	@FXML CheckBox crimeBox;
	@FXML CheckBox disneyBox;
	@FXML CheckBox documentaryBox;
	@FXML CheckBox dramaBox;
	@FXML CheckBox familyBox;
	@FXML CheckBox fantasyBox;
	@FXML CheckBox historyBox;
	@FXML CheckBox horrorBox;
	@FXML CheckBox musicBox;
	@FXML CheckBox musicalBox;
	@FXML CheckBox mysteryBox;
	@FXML CheckBox noirBox;
	@FXML CheckBox romanceBox;
	@FXML CheckBox scifiBox;
	@FXML CheckBox sportBox;
	@FXML CheckBox superheroBox;
	@FXML CheckBox thrillerBox;
	@FXML CheckBox warBox;
	@FXML CheckBox westernBox;

	ArrayList<CheckBox> addBoxes = new ArrayList<>();

	@FXML ComboBox<String> topGenresDropDown;
	@FXML Label topMovieLabel;

	@FXML TextField addTitle;
	@FXML ComboBox<String> addDate;
	@FXML ComboBox<String> addRating;

	@FXML Button recommendButton;

	@FXML TextField filterField;
	@FXML TableView<Movie> movieTable;
	@FXML TableColumn<Movie, String> titleColumn;
	@FXML TableColumn<Movie, String> dateColumn;
	@FXML TableColumn<Movie, String> genreColumn;
	@FXML TableColumn<Movie, String> imdbRatingColumn;
	@FXML TableColumn<Movie, String> ratingColumn;
	@FXML TableColumn<Movie, String> watchedColumn;
	@FXML Label numMovies;
	...
	private void initialize()
	{
		...
		movieTable.setRowFactory(tv -> new TableRow<Movie>() {
		    ...
		    protected void updateItem(Movie item, boolean empty) {
		        ...
		        pseudoClassStateChanged(movieWatched, 
		            item!=null && item.getWatched());
		    }
		});
	...
	{
		movieList.sortByBestMovies(topMovie);
	...
	@FXML
	void ratingEdit(TableColumn.CellEditEvent<Movie, String> ratingCell)
	{
